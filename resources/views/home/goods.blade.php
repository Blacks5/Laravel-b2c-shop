...
<head>
    ...
    <script type="text/javascript" src="{{asset('UI/assets/js/amazeui.js')}}"></script>
...
@include('layouts.header')
    <ol class="am-breadcrumb am-breadcrumb-slash">
        ...
        <li><a href="{{url('/list',['id'=>$goods->type])}}">分类</a></li>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="../images/01.jpg"><img src="{{asset($img[0])}}" alt="细节展示放大镜特效" rel="{{asset($img[0])}}" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    ...
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="javascript:;"><img src="{{asset($i)}}" mid="{{asset($i)}}" big="{{asset($i)}}"></a>
                        </div>
                    </li>
                    @else
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="javascrip:;"><img src="{{asset($i)}}" mid="{{asset($i)}}" big="{{asset($i)}}"></a>
                        </div>
                    </li>
                    @endif
                    @endforeach
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">{{$goods->sale}}</b>  </dd>
                    </li>
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em><b class="sys_item_mktprice">{{$goods->price}}.00</b></dd>
                    </li>
                    <div class="clear"></div>
                </div>
                                ...
                                <form class="theme-signin" name="loginform" action="" method="post">
                                    ...
                                    <div class="theme-signin-left">
                                        ...
                                        <div class="theme-options">
                                            ...
                                            <ul>
                                                <li class="sku-line selected" name="口味">原味<i></i></li>
                                        ...
                                        <div class="theme-options">
                                            ...
                                            <ul>
                                                <li class="sku-line selected" name="包装">手袋单人份<i></i></li>
...
<div class="pay">
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login">
            <a id="LikBuy" title="点此按钮到下一步确认购买信息" href="javascript:;" onclick="pay()">立即购买</a>
        </div>
    </li>
    <li>
        <div class="clearfix tb-btn tb-btn-basket theme-login">
            <a id="LikBasket" title="加入购物车" href="javascript:;" onclick="char()"><i></i>加入购物车</a>
        </div>
    </li>
</div>
<script>
function char(){
    if(checkLogin()){
        ...
        $.post("{{url('cart/create')}}",postData,function(data){
            if(data.s==1){
