    ...
    <div class="main-wrap">
        ...
        <div class="user-safety">
            ...
            <div class="user-infoPic">
                ...
                <div class="filePic">
                    <img class="am-circle am-img-thumbnail" src="{{asset($user->img)}}" alt="{{$user->name}}" />
                </div>
                ...
                <div class="info-m">
                    ...
                    <div class="safeText">
                        <a href="javascript:;">账户安全:<em style="margin-left:20px ;">60</em>分</a>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="m-left">
                            ...
                            <div class="fore2"><small>您验证的手机：{{empty($user->phone)?'请绑定手机,确保账号安全':$user->phone}} 若已丢失或停用，请立即更换</small></div>
                        </div>
                        <div class="fore3">
