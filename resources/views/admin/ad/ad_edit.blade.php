        ...
        <form class="panel panel-default" id="ad">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <select id="position_id">
                        <option value="" disabled>请选择广告位</option>
                        @foreach($data as $d)
                        <option value="{{$d->id}}" type="{{$d->type}}" {{$ad->position_id==$d->id?'selected':''}}>{{$d->name}}</option>
                        @endforeach
                    </select>
                    <label>请选择广告位</label>
                </div>
                <div class="input-field col s6">
                    ...
                    <input type="text" name="name" class="validate" id="name" value="{{$ad->name}}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input type="text" name="width" id="link" class="validate" value="{{$ad->link}}">
                </div>
                ...
                <div class="input-field col s9">
                    <input type="text" name="height" id="code" class="validate" placeholder="内容" value="{{$ad->code}}">
                </div>

            </div>
            <div class="row">
                <div class="input-field col s6">
                    <input placeholder="开始时间 不填默认永久" id="start_time" value="{{$ad->start_time}}">
                </div>
                <div class="input-field col s6">
                    <input placeholder="结束时间 不填默认永久" id="end_time" value="{{$ad->end_time}}">
                </div>
            </div>
            <div class="row">
                <div class="input-field col s3">
                    <input type="checkbox" id="enable" {{$ad->enable==1?'checked':''}}>
